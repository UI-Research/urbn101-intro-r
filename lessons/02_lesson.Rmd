...
`select()` is used when you want to limit the number of **columns** in your dataframe. The arguments after the dataframe should be names of columns, without quotes. `filter()` is used when you want to limit the number observations in your dataframe, based on certain criteria. Filter works with comparison
...
<font color="#ec008b">**The `%>%` operator**</font>
