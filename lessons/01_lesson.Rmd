...
<font color="#55b748">**Step 2:**</font> Open an `.R` script with the button in the top left (sheet with a plus sign icon). Save the script as `01_data-munging1.R`.

<font color="#55b748">**Step 3:**</font> Type `install.packages("tidyverse")` and hit enter (submit) to the Console.

<font color="#55b748">**Step 4:**</font> Write `library(tidyverse)` and at the top of `01_data-munging1.R`. With the cursor on the line of text, hit Control-Enter (at the same time). 
...
# Excercise 6
<font color="#55b748">**Step 1:**</font> Read in #Zillow Observed Rent Index (ZORI) data using `read_csv('LINK')` ()

<font color="#55b748">**Step 2:**</font> Read in zillow data using `read_csv('LINK')` ()
```
zillow_clean %>%
...
<font color="#55b748">**Step 3:**</font> Read in zillow data using `read_csv('LINK')` ()
  
# Exercise 7 (Mapping)
<font color="#55b748">**Step 1:**</font> Read in UFO sighting data (source: National UFO Reporting Center), link: _______________
