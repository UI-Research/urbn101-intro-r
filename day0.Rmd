...
<iframe width="2000" height="600" src="https://ui-research.github.io/r-at-urban/graphics-guide.html"></iframe>
...
Research and data are non-trival and non-exclusive. They are public goods that **should** be widely and easily shared. Decisions about tools, methods, data, and language during the research process **should** be made in ways that promote the ability of anyone and everyone to access an analysis. 
...
```{r out.width = "100%"}
knitr::include_graphics("www/images/schedule.png")
```
