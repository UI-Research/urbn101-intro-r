...
<font color="#55b748">**Step 2:**</font> `library(lubridate)` is powerful but it needs variables in the correct format. Use `ymd()` inside of `mutate()` to create a new variable called `flight_date` for the `flights_subset` data. 
