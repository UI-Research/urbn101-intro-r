...
* You want to apply a transformation to all variables in a data frame (or a 
subset of them).

# Packages

We'll be going back to the `dplyr` package and exploring the scoped 
variants of some of the functions we've seen already.
...
operation onto a selection of variables:
...
the function we want applied to all columns of our data frame:
